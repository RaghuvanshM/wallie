...
import HomeComponent from '../src/coponents/Home'
import SettinComponent from '../src/coponents/Setting'
import  UserComponent from '../src/coponents/user'
...
function MyTabs() {
    return (
        ...
        >
            ...
            />
            <Tab.Screen 
            name="Settings" component={SettinComponent} 
            options={{
                tabBarIcon: ({ focused }) => (
                    <Image
                        source={require('../src/assets/icons/scan.png')}
                        resizeMode="contain"
                        style={{
                            width: 45,
                            height: 45,
